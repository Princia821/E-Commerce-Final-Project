              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  <thead>
                    ...
                    <th  class=" text-center"> Edit Brand</th>
                    <th  class=" text-center"> Delete Brand</th>
                  ...
                  require('../controllers/service_controller.php');
                    ...
                    <tr>
                        ...
                        <td><a href='../actions/brand_process.php?deleteBrandID=<?= $bran['brand_id']?>' style='color:red'><i class='fa fa-trash'></i></a></td>
                    </tr>
